...
function [RP2,RV8,PA5x1,PA5x2] = load_circuits()

    % Connects to RP2, RV8, PA5s, loads/runs RP2 and RV8 circuits
    % Checks whether the circuits were loaded properly
    path='E:\Documents and Settings\Trainorlab\My Documents\Jeff Bruce\';
    rv8circ='SpeakerSwitching\PM2_EasySwitch.rco';
    ...
    % with amp dial pointing at 2 and 8, max volume on comp
    % set attenuation level for PA5x1 and PA5x2
    PA5x1.SetAtten(21);  % 62 dB SPL, set at 21
    PA5x2.SetAtten(10);  % 62 dB(A), set at 10
