% adaptive (2 down, 1 up) 2AFC narrow band gap detection task
function gapdetectionnoisepractice(hObject, handles, condition)

% SPECIFY PARAMETERS FOR EXPERIMENT
rand('seed', sum(100*clock()));
movegui(run_gap_detection_practice,'northwest');
...
pause(3);  % wait 2 seconds before first stimulus sequence
HideCursor();

% only run 6 trials for practice session
while (count <= 6)
