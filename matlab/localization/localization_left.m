function varargout = localization_left(varargin)
% LOCALIZATION_LEFT M-file for localization_left.fig
%      LOCALIZATION_LEFT, by itself, creates a new LOCALIZATION_LEFT or raises the existing
%      singleton*.
%
%      H = LOCALIZATION_LEFT returns the handle to a new LOCALIZATION_LEFT or the handle to
%      the existing singleton*.
%
%      LOCALIZATION_LEFT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LOCALIZATION_LEFT.M with the given input arguments.
%
%      LOCALIZATION_LEFT('Property','Value',...) creates a new LOCALIZATION_LEFT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before localization_left_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to localization_left_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help localization_left

% Last Modified by GUIDE v2.5 17-Oct-2011 13:15:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @localization_left_OpeningFcn, ...
                   'gui_OutputFcn',  @localization_left_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before localization_left is made visible.
function localization_left_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to localization_left (see VARARGIN)

global clicked;

% Choose default command line output for localization_left
...
if varargin{1} == 1
    handles.fileID = fopen(strcat('C:\Users\user\Documents\MATLAB\Neuro-Compensator\localization\data\left\','phone\',handles.subjname,'.txt'), 'w');
elseif varargin{1} == 2
    handles.fileID = fopen(strcat('C:\Users\user\Documents\MATLAB\Neuro-Compensator\localization\data\left\','low\',handles.subjname,'.txt'), 'w');
elseif varargin{1} == 3
    handles.fileID = fopen(strcat('C:\Users\user\Documents\MATLAB\Neuro-Compensator\localization\data\left\','high\',handles.subjname,'.txt'), 'w');
else
...
function varargout = localization_left_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    % read in image
    imageArray = imread('C:\Users\user\Documents\MATLAB\Neuro-Compensator\localization\response_interface_left.jpg');
    imageArray2 = imread('C:\Users\user\Documents\MATLAB\Neuro-Compensator\localization\response_zone_left.jpg');
...
if (pos(1) >= 102.4 && pos(2) >= 14.15) && (clicked == 0)
