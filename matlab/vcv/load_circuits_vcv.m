...
function [RP2,RV8,PA5x1,PA5x2] = load_circuits_vcv()
    ...
    PA5x1.SetAtten(10);  % 10 (ranges from 65-69 dB SPL C-weighting), most
                         % around 67
    PA5x2.SetAtten(12);  % 20 (ranges from 53-58 dB SPL A-weighting)
                         % 10 (ranges from 62-67 dB SPL A-weighting), most
                         % around 65
                         % 12 (ranges from 60-65 dB SPL A-weighting, most
                         % around 63
